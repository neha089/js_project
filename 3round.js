document.addEventListener("DOMContentLoaded", function () {
   ...
   function selectShark() {
    ...
    // Replace the clicked shark image with "x3.png"
    this.src = "x3.png";

    setTimeout(() => {
        // After 1 seconds, remove the "x3.png" image
        this.remove();
    ...
    localStorage.setItem('level3Score', score); // Add this line to store the Level 2 score
...
function clearSharkImages() {
    ...
    function goToNextLevel() {
        window.location.href = "4round.html";
    }
});