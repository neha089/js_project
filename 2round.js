document.addEventListener("DOMContentLoaded", function () {
    ...
    function moveSharks() {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            sharkImage.src = "mole" + (i + 1) + ".png";
            sharkImage.style.position = "absolute";
            sharkImage.style.width = "100px";
            sharkImage.style.height = "100px";
   ...
   function selectShark() {
    ...
    localStorage.setItem('level2Score', score); // Add this line to store the Level 2 score
